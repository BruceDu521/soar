...
LDFLAGS=-ldflags="-s -w -X 'github.com/BruceDu521/soar/common.Version=$(VERSION_VERSION)' -X 'github.com/BruceDu521/soar/common.Compile=$(VERSION_COMPILE)' -X 'github.com/BruceDu521/soar/common.Branch=$(VERSION_BRANCH)' -X 'github.com/BruceDu521/soar/common.GitDirty=$(VERSION_GIT_DIRTY)' -X 'github.com/BruceDu521/soar/common.DevPath=$(VERSION_DEV_PATH)'"
