...
func init() {
	...
	TestSQLs = []string{
		...
		// https://github.com/BruceDu521/soar/issues/47
		...
		// https://github.com/BruceDu521/soar/issues/17
		"create table hello.t (id int unsigned);",

		// https://github.com/BruceDu521/soar/issues/146
		"select * from tb where data >= '';",

		// https://github.com/BruceDu521/soar/issues/163
